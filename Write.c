...
int main() {
	...
	FILE *fptr;
	int i;
	fptr=fopen("C:\\Users\\LENOVO\\Desktop\\Sonika_C_Repository\\Sonika_CProgramm_\\Read.txt","wb"); //Opening the file from the location.
	for (i=0;i<1;++i) {
		fflush(stdin);
	...
	fclose(fptr);
	fptr=fopen("C:\\Users\\LENOVO\\Desktop\\Sonika_C_Repository\\Sonika_CProgramm_\\Read.txt","rb");
